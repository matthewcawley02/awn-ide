...
* //==================
* SPE :=
* 	  '\[ ' posDES=@ dataExp=DE posDEE=@ ' \]' lb sp proc=SPE procMore=SPE1?
* 	.procType = string {
* 		return "guard"
* 	}
...
* 		return "exists"
* 	}
* 	| posN=@ name=Name '\(' posS=@ dataExp=DE posE=@ '\)' dataExpMore=DE1?
* 	.dataExpType = string {
* 		return "function"
* 	}	
* 	| '\(' posS=@ dataExpFirst=DE dataExpW={', ' dataExp=DE}* posE=@ '\)' dataExpMore=DE1?
* 	.dataExpType = string {
* 		return "list"
* 	}
* 	| '\(' dataExp=DE '\)' dataExpMore=DE1?
...
export class BTE_AUX_1 {
    ...
    public posE: PosInfo;
    public typetype: string;
    constructor(posS: PosInfo, name: TypeName, posE: PosInfo){
        this.posS = posS;
        this.name = name;
        this.posE = posE;
        this.typetype = ((): string => {
...
export class SPE_2 {
    ...
    public procMore: Nullable<SPE1>;
    public procType: string;
    constructor(posA: PosInfo, name: Name, posB: PosInfo, dataExpList: SPE_$0[], posC: PosInfo, dataExpAssignment: DE, posD: PosInfo, proc: SPE, procMore: Nullable<SPE1>){
        this.posA = posA;
        this.name = name;
        this.posB = posB;
...
export class SPE_10 {
    ...
    public dataExpW: SPE_$2[];
    public procMore: Nullable<SPE1>;
    public procType: string;
    constructor(posS: PosInfo, name: Name, posE: PosInfo, dataExpFirst: Nullable<DE>, dataExpW: SPE_$2[], procMore: Nullable<SPE1>){
        this.posS = posS;
        this.name = name;
        this.posE = posE;
...
export type DE = DE_1 | DE_2 | DE_3 | DE_4 | DE_5 | DE_6 | DE_7 | DE_8 | DE_9 | DE_10;
export class DE_1 {
...
export class DE_7 {
    ...
    public dataExpMore: Nullable<DE1>;
    public dataExpType: string;
    constructor(posN: PosInfo, name: Name, posS: PosInfo, dataExp: DE, posE: PosInfo, dataExpMore: Nullable<DE1>){
        this.posN = posN;
        this.name = name;
        this.posS = posS;
        this.dataExp = dataExp;
...
export class DE_8 {
    ...
    public posS: PosInfo;
    public dataExpFirst: DE;
    public dataExpW: DE_$0[];
    public posE: PosInfo;
    public dataExpMore: Nullable<DE1>;
    public dataExpType: string;
    constructor(posS: PosInfo, dataExpFirst: DE, dataExpW: DE_$0[], posE: PosInfo, dataExpMore: Nullable<DE1>){
        this.posS = posS;
        this.dataExpFirst = dataExpFirst;
        this.dataExpW = dataExpW;
        this.posE = posE;
...
export class DE_10 {
    public kind: ASTKinds.DE_10 = ASTKinds.DE_10;
    public posS: PosInfo;
    public name: Name;
    public posE: PosInfo;
    public dataExpMore: Nullable<DE1>;
...
export type DE1 = DE1_1 | DE1_2 | DE1_3 | DE1_4 | DE1_5 | DE1_6 | DE1_7 | DE1_8 | DE1_9 | DE1_10 | DE1_11;
export class DE1_1 {
...
export class Parser {
    ...
    public matchSPE_10($$dpth: number, $$cr?: ErrorTracker): Nullable<SPE_10> {
        return this.run<SPE_10>($$dpth,
            () => {
                ...
                let $scope$dataExpW: Nullable<SPE_$2[]>;
                let $scope$procMore: Nullable<Nullable<SPE1>>;
                ...
                if (true
                    ...
                    && ($scope$dataExpW = this.loop<SPE_$2>(() => this.matchSPE_$2($$dpth + 1, $$cr), 0, -1)) !== null
                    && this.regexAccept(String.raw`(?:\))`, "", $$dpth + 1, $$cr) !== null
                    && (($scope$procMore = this.matchSPE1($$dpth + 1, $$cr)) || true)
                ) {
    ...
    public matchDE_8($$dpth: number, $$cr?: ErrorTracker): Nullable<DE_8> {
        return this.run<DE_8>($$dpth,
            () => {
                let $scope$posS: Nullable<PosInfo>;
                let $scope$dataExpFirst: Nullable<DE>;
                let $scope$dataExpW: Nullable<DE_$0[]>;
                let $scope$posE: Nullable<PosInfo>;
                let $scope$dataExpMore: Nullable<Nullable<DE1>>;
                ...
                if (true
                    && this.regexAccept(String.raw`(?:\()`, "", $$dpth + 1, $$cr) !== null
                    && ($scope$posS = this.mark()) !== null
                    && ($scope$dataExpFirst = this.matchDE($$dpth + 1, $$cr)) !== null
                    && ($scope$dataExpW = this.loop<DE_$0>(() => this.matchDE_$0($$dpth + 1, $$cr), 0, -1)) !== null
                    && ($scope$posE = this.mark()) !== null
                    && this.regexAccept(String.raw`(?:\))`, "", $$dpth + 1, $$cr) !== null
                    && (($scope$dataExpMore = this.matchDE1($$dpth + 1, $$cr)) || true)
                ) {
                    $$res = new DE_8($scope$posS, $scope$dataExpFirst, $scope$dataExpW, $scope$posE, $scope$dataExpMore);
                }
                return $$res;
            });
    }
        ...
        return this.run<DE_9>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = new DE_9($scope$dataExp, $scope$dataExpMore);
                }
                return $$res;
            });
    }
        ...
        return this.run<DE_10>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = new DE_10($scope$posS, $scope$name, $scope$posE, $scope$dataExpMore);
                }
                return $$res;
            });
    }
        ...
        return this.run<DE_$0>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.DE_$0, dataExp: $scope$dataExp};
                }
                return $$res;
            });
    }
        ...
        return this.run<DE1_11>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = new DE1_11($scope$func, $scope$dataExp, $scope$dataExpMore);
                }
                return $$res;
            });
    }
