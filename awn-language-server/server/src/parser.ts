...
export enum ASTKinds {
    ...
    NameString_$0_1 = "NameString_$0_1",
    NameString_$0_2 = "NameString_$0_2",
    NameChar = "NameChar",
    Infix = "Infix",
    _ = "_",
    $EOF = "$EOF",
...
export interface NameString {
    kind: ASTKinds.NameString;
}
export type NameString_$0 = NameString_$0_1 | NameString_$0_2;
export type NameString_$0_1 = NameString;
export type NameString_$0_2 = [NameChar, ...NameChar[]];
export type NameChar = string;
export type Infix = [string, ...string[]];
...
export class Parser {
        ...
        return this.run<Block_1>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && this.loopPlus<Block_$0>(() => this.matchBlock_$0($$dpth + 1, $$cr)) !== null
                ) {
        ...
        return this.run<Block_3>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && this.loopPlus<Block_$1>(() => this.matchBlock_$1($$dpth + 1, $$cr)) !== null
                ) {
        ...
        return this.run<Block_4>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && this.loopPlus<Block_$2>(() => this.matchBlock_$2($$dpth + 1, $$cr)) !== null
                ) {
        ...
        return this.run<Block_5>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && this.loopPlus<Block_$3>(() => this.matchBlock_$3($$dpth + 1, $$cr)) !== null
                ) {
        ...
        return this.run<Block_6>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && this.loopPlus<Block_$4>(() => this.matchBlock_$4($$dpth + 1, $$cr)) !== null
                ) {
        ...
        return this.run<Block_7>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && this.loopPlus<Block_$5>(() => this.matchBlock_$5($$dpth + 1, $$cr)) !== null
                ) {
        ...
        return this.run<Process_1>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && this.loopPlus<Process_$0>(() => this.matchProcess_$0($$dpth + 1, $$cr)) !== null
                    && this.regexAccept(String.raw`(?:\))`, "", $$dpth + 1, $$cr) !== null
                    && this.regexAccept(String.raw`(?::=)`, "", $$dpth + 1, $$cr) !== null
    ...
    public matchNameString($$dpth: number, $$cr?: ErrorTracker): Nullable<NameString> {
        return this.run<NameString>($$dpth,
            () => {
                let $$res: Nullable<NameString> = null;
                if (true
    ...
    public matchNameString_$0($$dpth: number, $$cr?: ErrorTracker): Nullable<NameString_$0> {
        return this.choice<NameString_$0>([
            () => this.matchNameString_$0_1($$dpth + 1, $$cr),
            () => this.matchNameString_$0_2($$dpth + 1, $$cr),
        ]);
    }
    public matchNameString_$0_1($$dpth: number, $$cr?: ErrorTracker): Nullable<NameString_$0_1> {
        return this.matchNameString($$dpth + 1, $$cr);
    }
    public matchNameString_$0_2($$dpth: number, $$cr?: ErrorTracker): Nullable<NameString_$0_2> {
